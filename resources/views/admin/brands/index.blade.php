    ...
    <div class="flex items-center justify-between gap-4 mb-4">
        ...
        <div class="flex items-center gap-3">
            <form id="brands-filter-form" method="GET" action="{{ route('admin.brands.index') }}" class="flex items-center gap-2">
                ...
                <select name="status" class="block p-2 border rounded-md text-sm">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <form action="{{ route('admin.brands.toggle', $brand) }}" method="POST" class="inline">
                                ...
                                @else
                                    <button type="submit" class="bg-green-100 hover:bg-green-200 text-green-700 p-2 rounded inline-flex items-center justify-center" title="Ativar marca">
